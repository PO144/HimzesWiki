...
- [ ] WIP param+sáv: narancssárga sáv noteokon és technique-eken, alul, beleírva work in progress, boolean, default false
...
You should make the examples button be the height of the link button, and you should make it have the little svg icon that the link button uses
