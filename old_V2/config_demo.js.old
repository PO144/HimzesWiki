...
const patches = [
  {
    ...
    image: "./images/techniques/satin-step1a.png",
    category: "Nature",
...
const notes = [
  {
    name: "Thread Direction Planning",
    description: "Plan stitch direction before starting so filled areas look cleaner and more intentional.",
    demoImage: "./images/techniques/satin-stitch.jpg",
    steps: [
      {
        name: "Check the Shape",
        description: "Look at the patch area and decide which stitch direction will best follow the form.",
        images: []
      },
      {
        name: "Mark the Direction",
        description: "If needed, lightly mark guide lines so the stitch flow stays consistent.",
        images: []
      },
      {
        name: "Keep It Consistent",
        description: "Once started, avoid changing direction halfway unless it is part of the intended effect.",
        images: []
      }
    ]
  },
  {
    name: "Test Tension First",
    description: "Before doing the actual patch, test your thread tension on scrap fabric.",
    demoImage: "./images/techniques/backstitch.jpg",
    steps: [
      {
        name: "Use Scrap Fabric",
        description: "Take a piece of similar backing or spare fabric and make a few lines or filled areas first.",
        images: []
      },
      {
        name: "Check for Puckering",
        description: "If the fabric pulls inward or wrinkles, your tension is too tight.",
        images: []
      },
      {
        name: "Adjust Before Starting",
        description: "Fix the tension before you start the real patch so you do not have to redo finished sections.",
        images: []
      }
    ]
  }
